...
#define DEFAULT_RCFILE    "/home/mods/Config/MODS/modsenv.ini" //!< default client runtime config file
...
// WAGO communication utilities (in the -I path)
...
int  wagoSetGet(int, char *, int, int, short [], int); // WAGO set/get data function
