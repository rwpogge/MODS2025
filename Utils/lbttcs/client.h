...
#define DEFAULT_RCFILE    "/home/mods/Config/IIF/lbttcs.ini" //!< default client runtime config file
#define DEFAULT_LOGFILE   "/home/mods/Logs/lbttcs.log" //!< default client runtime log file (unimplemented)
