/** \file agwfoc.c
 * \brief client for sending commands to the AGW Focux (z?)axis via the 
...
int agwfoc(char *host, char port[], char str1[])
{
  ...
  sprintf(send_buff, "agwfoc %s", str1); // Form message given by caller
