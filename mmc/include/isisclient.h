...
#define MED_STR_SIZE      256   //!< Length of a generic medium-sized string
#define BIG_STR_SIZE      512   //!< Length of a generic "big" string, bigger than medium, smaller than long
...
typedef struct client_info
{
  ...
  char   pgmFile[MED_STR_SIZE];    //!< path/name of the runtime log file
