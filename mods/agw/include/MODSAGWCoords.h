...
#define MODS2_AGWXMin          -93.0 //!< Minimum MODS2 AGW stage X-axis position in mm
#define MODS2_AGWXMax           91.0 //!< Maximum MODS2 AGW stage X-axis position in mm
...
#define MODS2_WFSYOffset         0.0 //!< Y-axis Offset of the MODS2 WFS pickoff mirror from the guider in millimeters
