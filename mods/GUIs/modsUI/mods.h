...
#define MODS_REV_NUMBER   "v3.2.1-archon"      //!< MODS UI Revision number
#define MODS_REV_DATE     "2026 Jan 19"        //!< Revision date

// Runtime files and paths

#define MODS_BASE_PATH    "/home/dts/mods" //!< Runtime base path
