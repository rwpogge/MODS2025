 ...
 * made "rootName" be "obsDate" in setup/*.cpp for consistent notation across the data-taking system

 
### Version 3.2.1 - 2026 Jan 19

Changes from live-testing at LBTO on the Jan 18/18 ECD night
...
## Version 2 - Binocular Operations

### Version 2.2.0 - 2024 July 8

- Qt 5.X -> Qt 6.X
    - The GUI should now be compiled using Qt 6.

### Version 2.1.0 - 2024 Feb 23
...
The version in use since 2014 when this repository was started.  This was the operational version that ran virtually unchanged
between 2014 and initial recon for the Archon updates in 2024

## Version 1 - Monocular opertions with MODS1 before MODS2 delivery

### Version 1.25.x - 2013 Aug 25
...
### Version 1.5 through 1.15 - 2010 Nov to 2011 June
...
## Version 0 - Beta Version (lab development)

### Version 0.9 - 2009 Dec 30
...
### Version 0.2 - 2008 May 26
 * Thorough overhaul of the data entry widgets (doubleentry.cpp, intentry.cpp, selectentry.cpp, etc.) as we learned what actually worked
 * Changes in textdisplay.cpp color manipulation using QPallet for greater consistency with Qt best practices

### Version 0.1 - 2008 Feb 25
