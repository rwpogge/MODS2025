...
#define AGWSIM_XSMAX   180 //!< Maximum XS-axis stage travel in microns from home (zero)
#define AGWSIM_YSMAX   200 //!< Maximum YS-axis stage travel in microns from home (zero)
...
#define AGWSIM_FMAX     20 //!< Maximum Focus travel in microns (in +YS axis direction)
...
#define AGWSIM_XMAXRATE 10 //!< Maximum absolute X-axis drift rate in microns/second
#define AGWSIM_YMINRATE     1 //!< Minimum absolute Y-axis drift rate in microns/second
#define AGWSIM_YMAXRATE 10 //!< Maximum absolute Y-axis drift rate in microns/second

#define AGWSIM_XCEN     90 //!< XS-axis location of the science-field center in microns
#define AGWSIM_YCEN    200 //!< YS-axis location of the science-field center in microns
#define AGWSIM_AGXMIN  -90 //!< Acquisition/Guide (AG) Camera minimum X(AG) position in microns
#define AGWSIM_AGXMAX   90 //!< Acquisition/Guide (AG) Camera maximum X(AG) position in microns
#define AGWSIM_AGYMIN       0 //!< Acquisition/Guide (AG) Camera minimum Y(AG) position in microns
#define AGWSIM_AGYMAX  180.5 //!< Acquisition/Guide (AG) Camera maximum Y(AG) position in microns

#define AGWSIM_WFSXOFF      0 //!< Off-axis Wavefront Sensor field center X(AG)-axis offset in microns
#define AGWSIM_WFSYOFF -12.500 //!< Off-axis Wavefront Sensor field center Y(AG)-axis offset in microns
...
#define MILLIM           1 //!< Convert microns to millimeters mechanism position
...
typedef struct agw_sim {
  ...
  double XS;           //!< Current AGW stage absolute X-axis position in microns from device axis home
  double YS;           //!< Current AGW stage absolute Y-axis position in microns from device axis home

  double Focus;        //!< Current AGW stage absolute Focus position in microns from device axis home
  double F0;           //!< Focus zero-point (absolute focus position at science field center in microns)
  long AutoFocus;    //!< AGW AutoFocus flag (0=disabled, 1=enabled, default: enabled)

  double XCen;         //!< XS-axis position of the science field center in microns from stage X home
  double YCen;         //!< YS-axis position of the science field center in microns from stage Y home

  double XAG;          //!< Acquisition/Guide Camera field-center X position in microns from #XCen
  double YAG;          //!< Acquisition/Guide Camera field-center Y position in microns from #YCen

  double XWFS;         //!< Off-Axis Wave-Front Sensor Camera field-center X position in microns from #XCen
  double YWFS;         //!< Off-Axis Wave-Front Sensor Camera field-center Y position in microns from #YCen
  ...
  double Xrate;        //!< Drift vector X component in microns/second
  double Yrate;        //!< Drift vector Y component in microns/second
