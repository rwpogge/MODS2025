...
/*!
  \file client.h
  \brief AGWSim Application Header

  ISIS client application header for the agwsim application.
...
#ifndef APP_CFGFILE
#define APP_CFGFILE "/home/dts/mods/Config/agwsim.ini"
#endif

// Default client application values (override/set in loadconfig.c)

#define DEFAULT_MYID      "AGW"  //!< default client ISIS node name
#define DEFAULT_MYPORT    7102   //!< default client socket port   
#define DEFAULT_RCFILE    APP_CFGFILE //!< default client runtime config file
#define DEFAULT_LOGFILE   "/home/dts/Logs/AGW/agwsim.log"   //!< default client runtime log file (unimplemented)
...
// This simulator uses the agwsim.h header to define an AGW stage simulator

#include "agwsim.h"

extern agw_sim_t agwsim; // global AGW stage simulator table
