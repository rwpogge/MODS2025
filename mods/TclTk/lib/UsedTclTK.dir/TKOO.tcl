...
# bind $w.mAent <Return> { exec imcsCtl mova $ttfA }
# bind $w.mBent <Return> { exec imcsCtl mova $ttfB }
# bind $w.mCent <Return> { exec imcsCtl mova $ttfC }
...
name)]
 ...
 label .m4lab -text "IMCS CMD:" -font $bfont
 entry .m4ent -textvariable ttfF -font $bfont -relief flat -bg grey -width 24
 pack  .m4lab .m4ent -side left
 bind  .m4ent <Return> { \
