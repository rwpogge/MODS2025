...
int 
setfilter(char *host, int agw_no, int new_pos, double velocity, int options)
{
  islcomp comp;
  islnum app;
  islconn conn;
  ...
  sprintf(send_buff,"setfilter %d",new_pos);
