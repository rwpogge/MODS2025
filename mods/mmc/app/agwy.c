/** \file agwy.c
 * \brief client for sending commands to the AGW Y axis via the 
...
int agwy(char *host, char port[], char str1[])
{
  ...
  sprintf(send_buff, "agwy %s", str1); // Form message given by caller
