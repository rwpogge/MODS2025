/** \file getparam.c
 * \brief client for sending commands to the getparam via the 
...
int getparam(char *host, char str[], char str1[])
{
  ...
  sprintf(send_buff, "getparam %s", str1); // Form message given by caller
