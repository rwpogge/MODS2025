/** \file hatch.c
 * \brief client for sending commands to the hatch via the 
...
int hatch(char *host, char *port, char str1[])
{
  ...
  sprintf(send_buff, "hatch %s", str1); // Form message given by caller
