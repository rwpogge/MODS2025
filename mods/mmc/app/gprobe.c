/** \file gprobe.c
 * \brief client for sending commands to the AGW Guide Probe via the 
...
int gprobe(char *host, char port[], char str1[])
{
  ...
  sprintf(send_buff, "gprobe %s", str1); // Form message given by caller
