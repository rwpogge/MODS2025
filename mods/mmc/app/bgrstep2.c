 ...
 * #2 via the MODS MicroLynx Controller Service (mmcService).
...
int bgrstep2(char *host, char str[], char str1[])
{
  ...
  sprintf(send_buff, "bgrstep2 %s", str1); // Form message given by caller
