/** \file agwfilt.c
 * \brief client for sending commands to the AGW Filter Wheel via the 
...
int agwfilt(char *host, char port[], char str1[])
{
  ...
  sprintf(send_buff, "agwfilt %s", str1); // Form message given by caller
