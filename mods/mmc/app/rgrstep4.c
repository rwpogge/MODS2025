/** \file rgrstep4.c
 * \brief client for sending commands to the Red Grating Select
 * #4 via the MODS MicroLynx Controller Service (mmcService).
...
int rgrstep4(char *host, char str[], char str1[])
{
  ...
  sprintf(send_buff, "rgrstep4 %s", str1); // Form message given by caller
