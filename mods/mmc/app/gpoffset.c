/** \file gpoffset.c
 * \brief client for sending commands to the AGW Guide Probe Offset via the 
...
int gpoffset(char *host, char port[], char str1[])
{
  ...
  sprintf(send_buff, "gpoffset %s", str1); // Form message given by caller
