/** \file mselect
 * \brief client for sending commands for cassette selection
 * and other commands are MicroLynx controller commands.
...
int mselect(char *host, char str[], char str1[])
{
  islcomp comp;
  islnum app;
  islconn conn;
  ...
  */
  ...
  sprintf(send_buff, "mselect %s", str1);
