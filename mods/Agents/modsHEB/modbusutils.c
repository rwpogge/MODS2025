...
/*!
    ...
    2025 Oct 4 - added 10ms pause between open and connect [rwp/osu]
...
wagoSetGet(int setGet, int isRegister, char *wagoAddr, int addr, int len, void* data)
{
  ...
  usleep(10000); // pause between open and connect
  ...
  usleep(10000); // pause for connect to finish before query
