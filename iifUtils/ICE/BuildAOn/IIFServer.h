...
public:
    ...
    bool __invoke(const ::lbto::IIFServerPrx&, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, const ::std::string&, const ::Ice::Context*);
...
public:
    ...
    ::lbto::result RotateCommon(::Ice::Double x, ::Ice::Double y, ::Ice::Double z, ::Ice::Double angle, ::Ice::Double direction, const ::std::string& side)
    {
        return RotateCommon(x, y, z, angle, direction, side, 0);
    }
    ::lbto::result RotateCommon(::Ice::Double x, ::Ice::Double y, ::Ice::Double z, ::Ice::Double angle, ::Ice::Double direction, const ::std::string& side, const ::Ice::Context& __ctx)
    {
        return RotateCommon(x, y, z, angle, direction, side, &__ctx);
    }
    
private:

    ::lbto::result RotateCommon(::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, const ::std::string&, const ::Ice::Context*);
    
public:
    bool RotateCommon_async(const ::lbto::AMI_IIFServer_RotateCommonPtr&, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, const ::std::string&);
    bool RotateCommon_async(const ::lbto::AMI_IIFServer_RotateCommonPtr&, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, const ::std::string&, const ::Ice::Context&);
...
public:
    ...
    ::lbto::result RunAO(bool repointFlag, const ::std::string& side)
    {
        return RunAO(repointFlag, side, 0);
    }
    ::lbto::result RunAO(bool repointFlag, const ::std::string& side, const ::Ice::Context& __ctx)
    {
        return RunAO(repointFlag, side, &__ctx);
    }
    
private:

    ::lbto::result RunAO(bool, const ::std::string&, const ::Ice::Context*);
    
public:
    bool RunAO_async(const ::lbto::AMI_IIFServer_RunAOPtr&, bool, const ::std::string&);
    bool RunAO_async(const ::lbto::AMI_IIFServer_RunAOPtr&, bool, const ::std::string&, const ::Ice::Context&);
...
public:
    ...
    void SetDDLogging(bool set, const ::Ice::Context& __ctx)
    {
        SetDDLogging(set, &__ctx);
    }
    
private:

    void SetDDLogging(bool, const ::Ice::Context*);
...
public:
    ...
    virtual ::lbto::result RotateCommon(::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, const ::std::string&, const ::Ice::Context*) = 0;
    ...
    virtual ::lbto::result RunAO(bool, const ::std::string&, const ::Ice::Context*) = 0;
    ...
    virtual void SetDDLogging(bool, const ::Ice::Context*) = 0;
...
public:
    ...
    virtual ::lbto::result RotateCommon(::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, const ::std::string&, const ::Ice::Context*);
    ...
    virtual ::lbto::result RunAO(bool, const ::std::string&, const ::Ice::Context*);
    ...
    virtual void SetDDLogging(bool, const ::Ice::Context*);
...
public:
    ...
    virtual ::lbto::result RotateCommon(::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, ::Ice::Double, const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ...
    virtual ::lbto::result RunAO(bool, const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ...
    virtual void SetDDLogging(bool, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___SetDDLogging(::IceInternal::Incoming&, const ::Ice::Current&);
