...
public:
    ...
    void destroyProxy(const ::std::string& proxyName)
    {
        destroyProxy(proxyName, 0);
    }
    void destroyProxy(const ::std::string& proxyName, const ::Ice::Context& __ctx)
    {
        destroyProxy(proxyName, &__ctx);
    }
    
private:

    void destroyProxy(const ::std::string&, const ::Ice::Context*);
    
public:

    ::std::string getProxy(const ::std::string& proxyName)
    {
        return getProxy(proxyName, 0);
    }
    ::std::string getProxy(const ::std::string& proxyName, const ::Ice::Context& __ctx)
    {
        return getProxy(proxyName, &__ctx);
    }
    
private:

    ::std::string getProxy(const ::std::string&, const ::Ice::Context*);
    
public:

    ::std::string getProxyInstrument(const ::std::string& proxyName)
    {
        return getProxyInstrument(proxyName, 0);
    }
    ::std::string getProxyInstrument(const ::std::string& proxyName, const ::Ice::Context& __ctx)
    {
        return getProxyInstrument(proxyName, &__ctx);
    }
    
private:

    ::std::string getProxyInstrument(const ::std::string&, const ::Ice::Context*);
    
public:

    ::std::string getProxyFocalStation(const ::std::string& proxyName)
    {
        return getProxyFocalStation(proxyName, 0);
    }
    ::std::string getProxyFocalStation(const ::std::string& proxyName, const ::Ice::Context& __ctx)
    {
        return getProxyFocalStation(proxyName, &__ctx);
    }
    
private:

    ::std::string getProxyFocalStation(const ::std::string&, const ::Ice::Context*);
...
public:
    ...
    virtual void destroyProxy(const ::std::string&, const ::Ice::Context*) = 0;

    virtual ::std::string getProxy(const ::std::string&, const ::Ice::Context*) = 0;

    virtual ::std::string getProxyInstrument(const ::std::string&, const ::Ice::Context*) = 0;

    virtual ::std::string getProxyFocalStation(const ::std::string&, const ::Ice::Context*) = 0;
...
public:
    ...
    virtual void destroyProxy(const ::std::string&, const ::Ice::Context*);

    virtual ::std::string getProxy(const ::std::string&, const ::Ice::Context*);

    virtual ::std::string getProxyInstrument(const ::std::string&, const ::Ice::Context*);

    virtual ::std::string getProxyFocalStation(const ::std::string&, const ::Ice::Context*);
