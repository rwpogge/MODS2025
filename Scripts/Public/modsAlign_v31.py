    ...
    def __init__(self,myInstID=None,myNX=None,myNY=None):
        ...
        if self.instID == None:
            ...
            if self.instID.lower() == 'mods1r':
                ...
                self.xRotCen = 1505
                self.yRotCen = 1537
                # LS60x5 slit reference position measured 2016 Oct 18 [rwp/osu]
                ...
                self.xRotCen = 1505
                self.yRotCen = 1537
                # LS60x5 slit reference position measured 2014 Jun 05 [rwp/osu]
                # LS60x5 slit reference x-position updated 2022 Sep 26 [opk/lbto]
                #self.xPhotCal = 502.0
                self.xPhotCal = 504.5
                self.yPhotCal = 620.0
                ...
                self.xRotCen = 1518
                self.yRotCen = 1522
                # LS60x5 slit reference position measured 2015 May 10 [rwp/osu]
                # Images mods2b.20150510.0002 and 0003
                # LS60x5 slit reference x-position updated 2022 Sep 26 [opk/lbto]
                #self.xPhotCal = 513.0
                self.xPhotCal = 510.0
                self.yPhotCal = 590.0
...
def getSlitPos(d, inst, mask, useXYRef, useOffset, yOffset, swFac=3, transform=True):
    ...
    if useXYRef and hasRef:
        ...
        xPix = xRef # use xRef,yRef as guesses, refine with SMS
        yPix = yRef
        try:
