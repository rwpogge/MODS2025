#
# mods2ShutDown - Do a full instrument shutdown
#
# Performs a full hardware shutdown of MODS2, including parking
...
# power-down MODS2 in preparation for a loss of power at the telescope,
# or to prepare MODS2 for dismounting from the telescope.
#
# modsColdStart would be used to recover from a modsShutDown
#
# MODS2 must powered on at the telescope and the software services
...
Exec:
   print *******************************
   print MODS2 Instrument Full Shut-Down
   print *******************************
   print This could take a couple of minutes.
   print This is only done when preparing to dismount MODS2 from the
   ...
   print It should not be used for putting MODS2 to sleep between runs.
   print Hit Enter to proceed or type Abort at the PAUSE if you do not 
   print wish to fully shutdown MODS2...

   pause

   # Go for it, bring up the systems one-by-one in order

   print Shutting Down MODS2...
   ...
   rcolfoc reset
   rgrating 1 # sensor gap not read properly - ok 2019may01[opk/lbto]
   rgrtilt1 hardreset  # not until we fix the cable [rwp/osu]...works now [opk]
   rcamfoc reset
   rfilter 1
