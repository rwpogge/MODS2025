#
# mods2CCDInit - Initialize the MODS2 CCD controllers
#
# Initializes the MODS2 CCD controllers after a controller
...
Exec:
  print Initializing the MODS2 CCD controllers

  # Makes sure that the HEBs have their TECs and Ion Gauges running but
  # the lab LED indicator lamps OFF (do not want LEDs on inside MODS2)
  ...
  print Done - MODS2 CCD controller state initialized
